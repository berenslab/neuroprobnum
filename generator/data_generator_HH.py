...
class data_generator_HH(data_generator):
    ...
    def poststep_clip_y(self, solver):
    ...
    def poststep_estimate_spike(self, solver):
        ...
        if spiked:
            ...
            if solver.DEBUG: self._plot_spike_estimate(solver, t_est, vidx=self._vidx, v_eval=self.thresh)
    ...
    def data2data_holder(**kwargs):
        return data_holder_HH(**kwargs)
    

class data_holder_HH(data_holder):
